...
<form method="POST" enctype="multipart/form-data" action="<?php echo URL; ?>extraService/save" id="form"
 ...
 <div class="row">
        ...
        <table class="table table-bordered">
            ...
            foreach ( $data as $item ) {
                ...
                ?>
                <tr>
                    <td><?php echo htmlspecialchars($item->extra_services_id); ?></td>
                    <td><?php echo htmlspecialchars($item->extra_services_name); ?></td>
                    <td><?php echo htmlspecialchars($item->extra_services_price); ?></td>
                    ...
                    <td><?php echo htmlspecialchars($item->descrption); ?></td>
                    <td>
                        <a class="btn btn-primary form-control" href="<?php echo URL . 'extraService/edit/' . htmlspecialchars($item->extra_services_id); ?>">Edit</a>
                    </td>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a type="button" class="btn btn-outline pull-right"
                                       href="<?php echo URL . 'extraService/delete/' . htmlspecialchars($item->extra_services_id); ?>"><?= $lang['Yes'] ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
