...
<form method="POST" action="<?php echo URL; ?>bathe/save" id="form"
 ...
 <div class="row">
        ...
        <table class="table table-bordered">
            ...
            foreach ( $data as $item ) {
                ...
                ?>
                <tr>
                    <td><?php echo htmlspecialchars($item->bathes_id); ?></td>
                    <td><?php echo htmlspecialchars($item->bathes_name); ?></td>
                    <td>
                        <a class="btn btn-primary form-control" href="<?php echo URL . 'bathe/edit/' . htmlspecialchars($item->bathes_id); ?>">Edit</a>
                    </td>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a type="button" class="btn btn-outline pull-right"
                                       href="<?php echo URL . 'bathe/delete/' . htmlspecialchars($item->bathes_id); ?>"><?= $lang['Yes'] ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
