...
<form method="POST" action="<?php echo URL; ?>maintenance/save" id="form"
 ...
 <div class="row">
        ...
        <table class="table table-bordered">
            ...
            foreach ( $data as $item ) {
                ...
                ?>
                <tr>
                    <td><?php echo htmlspecialchars($item->maintenance_id); ?></td>
                    <td><?php echo htmlspecialchars($item->maintenance_name); ?></td>
                    <td>
                        <a class="btn btn-primary form-control" href="<?php echo URL . 'maintenance/edit/' . htmlspecialchars($item->maintenance_id); ?>">Edit</a>
                    </td>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a type="button" class="btn btn-outline pull-right"
                                       href="<?php echo URL . 'maintenance/delete/' . htmlspecialchars($item->maintenance_id); ?>"><?= $lang['Yes'] ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
